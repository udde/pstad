...
vec3 depthColor(float idx)
{
    ...
    if(idx == 0.0)
        c = vec3(221,65,65)/255.0; //röd
    if(idx == 1.0)
        c = vec3(233,33,165)/255.0; //rosa skit
    if(idx == 2.0)
        c = vec3(180,18,228)/255.0; //lila
    if(idx == 3.0)
        c = vec3(99,13,240)/255.0; //mörkare blå
    if(idx == 4.0)
        c =vec3(17,39,238)/255.0; //blå
    if(idx == 5.0)
        c = vec3(6,227,241)/255.0; //turkos
    if(idx == 6.0)
        c = vec3(5,232,143)/255.0; //grön
    if(idx == 7.0)
        c = vec3(61,227,45)/255.0;  //grön
    if(idx == 8.0)
        c  = vec3(208,246,21)/255.0; //gul
    if(idx == 9.0)
        c  = vec3(255,245,13)/255.0;  //gul
    if(idx == 10.0)
        c = vec3(247,172,43)/255.0;  //orNGE
    if(idx == 11.0)
        c = vec3(168,108,59)/255.0;  //brun
...
void main() {
    ...
    gl_FragColor.xyz = vNormal;//depthColor(vColor.x);//diffuse + ambient + spec;
    gl_FragColor.a = 1.0;
}
